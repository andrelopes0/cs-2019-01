	...
	function Propriedade153(var cdu){
	...
	function DiaDaSemana(var dia, var mes, var ano){
	...
	function ProdutoDeInteirosUsandoSomas(var a, var b){
	...
	function LogaritmoNatural(var n, var k){
	...
	function RazaoAurea(var x, var y, var k){
	...
	function QuadradoPerfeito(var n){
	...
	function RaizQuadrada(var n, var i){
	...
	function CrivoEratostenes(var a[], var n){
